...
print(">> zdx_comfyui: starting imports...")
try:
    print(">> zdx_comfyui: importing dynamic_code...")
    from .dynamic_code import _NODE_CLASS_MAPPINGS as DynamicCodeMappings
    print(">> zdx_comfyui: importing refiner_v1...")
    from .refiner_v1 import Refinerv1
    print(">> zdx_comfyui: importing ic_light_v1...")
    from .ic_light_v1 import ICLightv1
    print(">> zdx_comfyui: importing refiner_v1pro...")
    from .refiner_v1pro import Refinerv1Pro
    print(">> zdx_comfyui: importing refiner_f1...")
    from .refiner_f1 import RefinerF1
    print(">> zdx_comfyui: importing supir...")
    from .supir import SupirXL
    print(">> zdx_comfyui: importing focus_crop_match...")
    ...
    print(">> zdx_comfyui: importing yolo_node...")
    from .yolo_node  import MainObjDetect, YoloDetect, MainObjExtract, YoloHalfBodyCheckNode
    print(">> zdx_comfyui: importing repaint_f1...")
    from .repaint_f1 import HandFixF1
    print(">> zdx_comfyui: importing repaint_v1...")
    from .repaint_v1 import RepaintV1
    print(">> zdx_comfyui: importing layerstyle.seamless_blend...")
    from .layerstyle.seamless_blend import SeamlessBlend    # bad,目标图对象与底图都要一样大进行贴合，算法上很难对准与做一些其他策略~
    print(">> zdx_comfyui: importing layerstyle.poisson_blend...")
...
NODE_CLASS_MAPPINGS = {
    ...
    "YoloDetect": YoloDetect,"YoloHalfBodyCheckNode": YoloHalfBodyCheckNode,
    # mask
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "MainObjDetect": "MainObjDetect",
    "MainObjExtract": "MainObjExtract",
    "zdxYoloDetect": "YoloDetect","YoloHalfBodyCheckNode": "YoloHalfBodyCheckNode",
    # mask
    "zdxApplySageAttention": "zdxApplySageAttention",
    # image
    "FocusCrop": "FocusCrop",
    ...
    # "XL InstantFaceSwap": "InstantFaceSwap",
}
if InstantFaceSwap is not None:
...
print(">> zdx_comfyui: importing dynamic_code mappings...")
from .dynamic_code import _NODE_CLASS_MAPPINGS as DynamicCodeMappings
...
print(">> zdx_comfyui: importing llm mappings...")
try:
    from .llm import _NODE_CLASS_MAPPINGS as LLM_NODE_CLASS_MAPPINGS
    from .llm import _NODE_DISPLAY_NAME_MAPPINGS as LLM_NODE_DISPLAY_NAME_MAPPING
    NODE_CLASS_MAPPINGS.update(LLM_NODE_CLASS_MAPPINGS)
    NODE_DISPLAY_NAME_MAPPINGS.update(LLM_NODE_DISPLAY_NAME_MAPPING)
except Exception as e:
    print(f">> zdx_comfyui llm mappings skipped: {e}")

# from .mask import ObjExtractByMask,MaskAdd,MaskSubtraction,MaskExpand, GrowMaskEdgeBlur, MaskCombine, isMaskEmpty
print(">> zdx_comfyui: importing mask mappings...")
...
print(">> zdx_comfyui: all imports done.")
