...
class PositionImageBlend:
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "scale_factor": ("FLOAT", {"default": 1.0, "min": 0.0, "max": 5.0, "step": 0.01}),
    ...
    def blend_image(self, init_image, source_image, source_mask, blend_mode, scale_factor=1.0, max_or_min_match="min", init_mask=None):
        ...
        if init_mask is not None:
            ...
            scale_factor = min(init_mask_w / src_obj_w, init_mask_h / src_obj_h) if max_or_min_match == "min" else max(init_mask_w / src_obj_w, init_mask_h / src_obj_h)
