...
class WanVacePoseChange:
    ...
    def forward(self,image_1=None,video_url=None,width=576,height=1024,fps=16):
        """
        视频换人（单模型）：参考人物图 + 原视频 -> WanVideo AnimateEmbeds -> 采样 -> 解码 -> 合成，返回本地视频路径。
        """
